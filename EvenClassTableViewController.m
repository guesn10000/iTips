...
@implementation EvenClassTableViewController
...
- (void)setClockTime:(int)t andClockNumber:(int)n {
    ...
    if (noti1) {
        ...
        NSDictionary *notiDic = [NSDictionary dictionaryWithObjectsAndKeys:showEndWeek, @"endWeek", weekType, @"weekType", [NSString stringWithFormat:@"%i", t + 100], @"time", nil];
    ...
    if (noti2 && n == 3) {
        ...
        NSDictionary *notiDic = [NSDictionary dictionaryWithObjectsAndKeys:showEndWeek2, @"endWeek", weekType, @"weekType", [NSString stringWithFormat:@"%i", t + 100], @"time", nil];
...
- (void)viewDidLoad
{
    ...
    if (w == 1) {
        if (t== 1)
        {
            ...
            [saveDataToFile saveGameData2:ct_mon1 saveFileName:@"2mon1"];
        ...
        else if (t == 2)
        {
            ...
            [saveDataToFile saveGameData2:ct_mon2 saveFileName:@"2mon2"];
        ...
        else //if (t == 3)
        {
            ...
            [saveDataToFile saveGameData2:ct_mon3 saveFileName:@"2mon3"];
        ...
        if (t == 1)
        {
            ...
            [saveDataToFile saveGameData2:ct_tue1 saveFileName:@"2tue1"];
        ...
        else if (t ==2)
        {
            ...
            [saveDataToFile saveGameData2:ct_tue2 saveFileName:@"2tue2"];
        ...
        else //if (t == 3)
        {
            ...
            [saveDataToFile saveGameData2:ct_tue3 saveFileName:@"2tue3"];
        ...
        if (t == 1)
        {
            ...
            [saveDataToFile saveGameData2:ct_wed1 saveFileName:@"2wed1"];
        ...
        else if (t== 2)
        {
            ...
            [saveDataToFile saveGameData2:ct_wed2 saveFileName:@"2wed2"];
        ...
        else //if (t == 3)
        {
            ...
            [saveDataToFile saveGameData2:ct_wed3 saveFileName:@"2wed3"];
        ...
        if (t == 1)
        {
            ...
            [saveDataToFile saveGameData2:ct_thu1 saveFileName:@"2thu1"];
        ...
        else if (t == 2)
        {
            ...
            [saveDataToFile saveGameData2:ct_thu2 saveFileName:@"2thu2"];
        ...
        else //if (t == 3)
        {
            ...
            [saveDataToFile saveGameData2:ct_thu3 saveFileName:@"2thu3"];
        ...
        if (t == 1)
        {
            ...
            [saveDataToFile saveGameData2:ct_fri1 saveFileName:@"2fri1"];
        ...
        else if (t == 2)
        {
            ...
            [saveDataToFile saveGameData2:ct_fri2 saveFileName:@"2fri2"];
        ...
        else //if (t ==3)
        {
            ...
            [saveDataToFile saveGameData2:ct_fri3 saveFileName:@"2fri3"];
        ...
        if (t == 1)
        {
            ...
            [saveDataToFile saveGameData2:ct_sat1 saveFileName:@"2sat1"];
        ...
        else if (t == 2)
        {
            ...
            [saveDataToFile saveGameData2:ct_sat2 saveFileName:@"2sat2"];
        ...
        else //if (t == 3)
        {
            ...
            [saveDataToFile saveGameData2:ct_sat3 saveFileName:@"2sat3"];
        ...
        if (t == 1)
        {
            ...
            [saveDataToFile saveGameData2:ct_sun1 saveFileName:@"2sun1"];
        ...
        else if (t == 2)
        {
            ...
            [saveDataToFile saveGameData2:ct_sun2 saveFileName:@"2sun2"];
        ...
        else //if (t == 3)
        {
            ...
            [saveDataToFile saveGameData2:ct_sun3 saveFileName:@"2sun3"];
    ...
    NSMutableArray *ct_mon1 = [loadDataFromFile loadGameData2:@"mon1"];
    NSMutableArray *ct_mon2 = [loadDataFromFile loadGameData2:@"mon2"];
    NSMutableArray *ct_mon3 = [loadDataFromFile loadGameData2:@"mon3"];
    
    NSMutableArray *ct_tue1 = [loadDataFromFile loadGameData2:@"tue1"];
    NSMutableArray *ct_tue2 = [loadDataFromFile loadGameData2:@"tue2"];
    NSMutableArray *ct_tue3 = [loadDataFromFile loadGameData2:@"tue3"];
    
    NSMutableArray *ct_wed1 = [loadDataFromFile loadGameData2:@"wed1"];
    NSMutableArray *ct_wed2 = [loadDataFromFile loadGameData2:@"wed2"];
    NSMutableArray *ct_wed3 = [loadDataFromFile loadGameData2:@"wed3"];
    
    NSMutableArray *ct_thu1 = [loadDataFromFile loadGameData2:@"thu1"];
    NSMutableArray *ct_thu2 = [loadDataFromFile loadGameData2:@"thu2"];
    NSMutableArray *ct_thu3 = [loadDataFromFile loadGameData2:@"thu3"];
    
    NSMutableArray *ct_fri1 = [loadDataFromFile loadGameData2:@"fri1"];
    NSMutableArray *ct_fri2 = [loadDataFromFile loadGameData2:@"fri2"];
    NSMutableArray *ct_fri3 = [loadDataFromFile loadGameData2:@"fri3"];
    
    NSMutableArray *ct_sat1 = [loadDataFromFile loadGameData2:@"sat1"];
    NSMutableArray *ct_sat2 = [loadDataFromFile loadGameData2:@"sat2"];
    NSMutableArray *ct_sat3 = [loadDataFromFile loadGameData2:@"sat3"];
    
    NSMutableArray *ct_sun1 = [loadDataFromFile loadGameData2:@"sun1"];
    NSMutableArray *ct_sun2 = [loadDataFromFile loadGameData2:@"sun2"];
    NSMutableArray *ct_sun3 = [loadDataFromFile loadGameData2:@"sun3"];
    
    
    NSMutableArray *ct_mon_1 = [loadDataFromFile loadGameData2:@"2mon1"];
    NSMutableArray *ct_mon_2 = [loadDataFromFile loadGameData2:@"2mon2"];
    NSMutableArray *ct_mon_3 = [loadDataFromFile loadGameData2:@"2mon3"];
    
    NSMutableArray *ct_tue_1 = [loadDataFromFile loadGameData2:@"2tue1"];
    NSMutableArray *ct_tue_2 = [loadDataFromFile loadGameData2:@"2tue2"];
    NSMutableArray *ct_tue_3 = [loadDataFromFile loadGameData2:@"2tue3"];
    
    NSMutableArray *ct_wed_1 = [loadDataFromFile loadGameData2:@"2wed1"];
    NSMutableArray *ct_wed_2 = [loadDataFromFile loadGameData2:@"2wed2"];
    NSMutableArray *ct_wed_3 = [loadDataFromFile loadGameData2:@"2wed3"];
    
    NSMutableArray *ct_thu_1 = [loadDataFromFile loadGameData2:@"2thu1"];
    NSMutableArray *ct_thu_2 = [loadDataFromFile loadGameData2:@"2thu2"];
    NSMutableArray *ct_thu_3 = [loadDataFromFile loadGameData2:@"2thu3"];
    
    NSMutableArray *ct_fri_1 = [loadDataFromFile loadGameData2:@"2fri1"];
    NSMutableArray *ct_fri_2 = [loadDataFromFile loadGameData2:@"2fri2"];
    NSMutableArray *ct_fri_3 = [loadDataFromFile loadGameData2:@"2fri3"];
    
    NSMutableArray *ct_sat_1 = [loadDataFromFile loadGameData2:@"2sat1"];
    NSMutableArray *ct_sat_2 = [loadDataFromFile loadGameData2:@"2sat2"];
    NSMutableArray *ct_sat_3 = [loadDataFromFile loadGameData2:@"2sat3"];
    
    NSMutableArray *ct_sun_1 = [loadDataFromFile loadGameData2:@"2sun1"];
    NSMutableArray *ct_sun_2 = [loadDataFromFile loadGameData2:@"2sun2"];
    NSMutableArray *ct_sun_3 = [loadDataFromFile loadGameData2:@"2sun3"];
    
    
    self.mon1.text = (ct_mon_1[0] == nil) ? ((ct_mon1[0] == nil) ? @"" : ct_mon1[0]) : ct_mon_1[0];
    self.mon2.text = (ct_mon_2[0] == nil) ? ((ct_mon2[0] == nil) ? @"" : ct_mon2[0]) : ct_mon_2[0];
    self.mon3.text = (ct_mon_3[0] == nil) ? ((ct_mon3[0] == nil) ? @"" : ct_mon3[0]) : ct_mon_3[0];
    
    self.tue1.text = (ct_tue_1[0] == nil) ? ((ct_tue1[0] == nil) ? @"" : ct_tue1[0]) : ct_tue_1[0];
    self.tue2.text = (ct_tue_2[0] == nil) ? ((ct_tue2[0] == nil) ? @"" : ct_tue2[0]) : ct_tue_2[0];
    self.tue3.text = (ct_tue_3[0] == nil) ? ((ct_tue3[0] == nil) ? @"" : ct_tue3[0]) : ct_tue_3[0];
    
    self.wed1.text = (ct_wed_1[0] == nil) ? ((ct_wed1[0] == nil) ? @"" : ct_wed1[0]) : ct_wed_1[0];
    self.wed2.text = (ct_wed_2[0] == nil) ? ((ct_wed2[0] == nil) ? @"" : ct_wed2[0]) : ct_wed_2[0];
    self.wed3.text = (ct_wed_3[0] == nil) ? ((ct_wed3[0] == nil) ? @"" : ct_wed3[0]) : ct_wed_3[0];
    
    self.thu1.text = (ct_thu_1[0] == nil) ? ((ct_thu1[0] == nil) ? @"" : ct_thu1[0]) : ct_thu_1[0];
    self.thu2.text = (ct_thu_2[0] == nil) ? ((ct_thu2[0] == nil) ? @"" : ct_thu2[0]) : ct_thu_2[0];
    self.thu3.text = (ct_thu_3[0] == nil) ? ((ct_thu3[0] == nil) ? @"" : ct_thu3[0]) : ct_thu_3[0];
    
    self.fri1.text = (ct_fri_1[0] == nil) ? ((ct_fri1[0] == nil) ? @"" : ct_fri1[0]) : ct_fri_1[0];
    self.fri2.text = (ct_fri_2[0] == nil) ? ((ct_fri2[0] == nil) ? @"" : ct_fri2[0]) : ct_fri_2[0];
    self.fri3.text = (ct_fri_3[0] == nil) ? ((ct_fri3[0] == nil) ? @"" : ct_fri3[0]) : ct_fri_3[0];
    
    self.sat1.text = (ct_sat_1[0] == nil) ? ((ct_sat1[0] == nil) ? @"" : ct_sat1[0]) : ct_sat_1[0];
    self.sat2.text = (ct_sat_2[0] == nil) ? ((ct_sat2[0] == nil) ? @"" : ct_sat2[0]) : ct_sat_2[0];
    self.sat3.text = (ct_sat_3[0] == nil) ? ((ct_sat3[0] == nil) ? @"" : ct_sat3[0]) : ct_sat_3[0];
    
    self.sun1.text = (ct_sun_1[0] == nil) ? ((ct_sun1[0] == nil) ? @"" : ct_sun1[0]) : ct_sun_1[0];
    self.sun2.text = (ct_sun_2[0] == nil) ? ((ct_sun2[0] == nil) ? @"" : ct_sun2[0]) : ct_sun_2[0];
    self.sun3.text = (ct_sun_3[0] == nil) ? ((ct_sun3[0] == nil) ? @"" : ct_sun3[0]) : ct_sun_3[0];
